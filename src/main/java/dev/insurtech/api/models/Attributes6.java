...
public class Attributes6 {
     ...
     * @param  documentId  UUID value for documentId.
     ...
     * UUID that identifies the document for this policy.
     * @param documentId Value for UUID
     */
    ...
    public String toString() {
        return "Attributes6 [" + "createdDate=" + createdDate + ", modifiedDate=" + modifiedDate
                + ", documentId=" + documentId + ", actualEndDate=" + actualEndDate + ", status="
                + status + ", earnedPremium=" + earnedPremium + ", earnedTax=" + earnedTax
                + ", earnedFees=" + earnedFees + ", cancelReason=" + cancelReason
                + ", cancelDescription=" + cancelDescription + ", policyNumber=" + policyNumber
                + ", effectiveDate=" + effectiveDate + ", externalReference=" + externalReference
                + ", limit=" + limit + ", deductible=" + deductible + ", policyState=" + policyState
                + ", metadata=" + metadata + ", termEndDate=" + termEndDate + ", installmentPlan="
                + installmentPlan + ", writtenPremium=" + writtenPremium + ", issueDate="
                + issueDate + ", nonRenewalNoticeDate=" + nonRenewalNoticeDate
                + ", cancellationNoticeDate=" + cancellationNoticeDate
                + ", requestedCancellationDate=" + requestedCancellationDate + ", stateTax="
                + stateTax + ", stateFees=" + stateFees + ", serviceFees=" + serviceFees
                + ", termPremium=" + termPremium + ", billingFees=" + billingFees + "]";
    }
    ...
    public static class Builder {
        ...
        public Attributes6 build() {
            return new Attributes6(createdDate, modifiedDate, documentId, actualEndDate, status,
                    earnedPremium, earnedTax, earnedFees, cancelReason, cancelDescription,
                    policyNumber, effectiveDate, externalReference, limit, deductible, policyState,
                    metadata, termEndDate, installmentPlan, writtenPremium, issueDate,
                    nonRenewalNoticeDate, cancellationNoticeDate, requestedCancellationDate,
                    stateTax, stateFees, serviceFees, termPremium, billingFees);
        }
    }
}
